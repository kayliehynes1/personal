...
class LobbyScreen(BaseScreen):
    ...
    def _build(self) -> None:
        ...
        bar.pack(fill="x")
        tk.Label(bar, text="SUDOKU PLATFORM", font=("Courier", 14, "bold"),
 ...
 #NEW CODE =======================================================================
        scroll_container = tk.Frame(self, bg=t["bg"])
        scroll_container.pack(fill='both', expand=True, padx=40, pady=(0,4))
...
#==================END OF NEW CODE ================================================
    ...
    def _puzzle_row(self, puzzle: dict) -> None:
        ...
        # DB has no title — use "Puzzle #<id>" as display name
