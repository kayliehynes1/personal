...
class SudokuDB:
    ...
    #Fixing username instead of user_id 
    ...
    def get_user_stats(self, user_id: int) -> dict:
        ...
        cursor.execute(
            ...
            "WHERE puzzles_solved > (SELECT puzzles_solved FROM user_stats WHERE user_id = ?)",
            (user_id,),
        )
        ...
        result["best_time"] = times["best_time"] if times else None
        result["avg_time"] = times["avg_time"] if times else None
        result["rank"] = rank["rank"] if rank else "-"
